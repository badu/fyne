...
func TestHandleOutput_ANSI_Colors(t *testing.T) {
	tests := map[string]struct {
		...
		"[31m": {
			inputSeq:     esc("[31m"),
			expectedFg:   &color.RGBA{R: 170, A: 255},
			expectedBg:   nil,
			expectedBold: false,
		},
		"[32m": {
			inputSeq:     esc("[32m"),
			expectedFg:   &color.RGBA{G: 170, A: 255},
			expectedBg:   nil,
			expectedBold: false,
		},
		"[33m": {
			inputSeq:     esc("[33m"),
			expectedFg:   &color.RGBA{R: 170, G: 170, A: 255},
			expectedBg:   nil,
			expectedBold: false,
		},
		"[34m": {
			inputSeq:     esc("[34m"),
			expectedFg:   &color.RGBA{B: 170, A: 255},
			expectedBg:   nil,
			expectedBold: false,
		},
		"[35m": {
			inputSeq:     esc("[35m"),
			expectedFg:   &color.RGBA{R: 170, B: 170, A: 255},
			expectedBg:   nil,
			expectedBold: false,
		},
		"[36m": {
			inputSeq:     esc("[36m"),
			expectedFg:   &color.RGBA{G: 255, B: 255, A: 255},
			expectedBg:   nil,
			expectedBold: false,
		},
		"[37m": {
			inputSeq:     esc("[37m"),
			expectedFg:   &color.RGBA{R: 170, G: 170, B: 170, A: 255},
			expectedBg:   nil,
			expectedBold: false,
		},
		"bold": {
...
func TestHandleOutput_xterm_bright(t *testing.T) {
	tests := map[string]struct {
		...
		"[90m": {
			inputSeq:     esc("[90m"),
			expectedFg:   &color.RGBA{R: 85, G: 85, B: 85, A: 255},
			expectedBg:   nil,
			expectedBold: false,
		},
		"[100m": {
			inputSeq:     esc("[100m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{R: 85, G: 85, B: 85, A: 255},
			expectedBold: false,
		},
		"[91m": {
			inputSeq:     esc("[91m"),
			expectedFg:   &color.RGBA{R: 255, G: 85, B: 85, A: 255},
			expectedBg:   nil,
			expectedBold: false,
		},
		"[101m": {
			inputSeq:     esc("[101m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{R: 255, G: 85, B: 85, A: 255},
			expectedBold: false,
		},
		"[92m": {
			inputSeq:     esc("[92m"),
			expectedFg:   &color.RGBA{R: 85, G: 255, B: 85, A: 255},
			expectedBg:   nil,
			expectedBold: false,
		},
		"[102m": {
			inputSeq:     esc("[102m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{R: 85, G: 255, B: 85, A: 255},
			expectedBold: false,
		},
		"[93m": {
			inputSeq:     esc("[93m"),
			expectedFg:   &color.RGBA{R: 255, G: 255, B: 85, A: 255},
			expectedBg:   nil,
			expectedBold: false,
		},
		"[103m": {
			inputSeq:     esc("[103m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{R: 255, G: 255, B: 85, A: 255},
			expectedBold: false,
		},
		"[94m": {
			inputSeq:     esc("[94m"),
			expectedFg:   &color.RGBA{R: 85, G: 85, B: 255, A: 255},
			expectedBg:   nil,
			expectedBold: false,
		},
		"[104m": {
			inputSeq:     esc("[104m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{R: 85, G: 85, B: 255, A: 255},
			expectedBold: false,
		},
		"[95m": {
			inputSeq:     esc("[95m"),
			expectedFg:   &color.RGBA{R: 255, G: 85, B: 255, A: 255},
			expectedBg:   nil,
			expectedBold: false,
		},
		"[105m": {
			inputSeq:     esc("[105m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{R: 255, G: 85, B: 255, A: 255},
			expectedBold: false,
		},
		"[96m": {
			inputSeq:     esc("[96m"),
			expectedFg:   &color.RGBA{R: 85, G: 255, B: 255, A: 255},
			expectedBg:   nil,
			expectedBold: false,
		},
		...
		"[106m": {
			inputSeq:     esc("[106m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{R: 85, G: 255, B: 255, A: 255},
			expectedBold: false,
		},
		"[97m": {
			inputSeq:     esc("[97m"),
			expectedFg:   &color.RGBA{R: 255, G: 255, B: 255, A: 255},
			expectedBg:   nil,
			expectedBold: false,
		},
		"[107m": {
			inputSeq:     esc("[107m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{R: 255, G: 255, B: 255, A: 255},
			expectedBold: false,
		},
	}
...
func TestHandleOutput_xterm_256_1(t *testing.T) {
	tests := map[string]struct {
		...
		"[48;5;16m": {
			...
			expectedFg:   nil,
			expectedBg:   &color.RGBA{A: 255},
			expectedBold: false,
		},
		"[48;5;232m": {
			inputSeq:     esc("[48;5;232m"),
			expectedFg:   nil,
			expectedBg:   &color.Gray{},
			expectedBold: false,
		},
		"[48;5;233m": {
			inputSeq:     esc("[48;5;233m"),
			expectedFg:   nil,
			expectedBg:   &color.Gray{Y: 10},
			expectedBold: false,
		},
		"[48;5;234m": {
			inputSeq:     esc("[48;5;234m"),
			expectedFg:   nil,
			expectedBg:   &color.Gray{Y: 20},
			expectedBold: false,
		},
		"[48;5;235m": {
			inputSeq:     esc("[48;5;235m"),
			expectedFg:   nil,
			expectedBg:   &color.Gray{Y: 30},
			expectedBold: false,
		},
		"[48;5;236m": {
			inputSeq:     esc("[48;5;236m"),
			expectedFg:   nil,
			expectedBg:   &color.Gray{Y: 40},
			expectedBold: false,
		},
		"[48;5;237m": {
			inputSeq:     esc("[48;5;237m"),
			expectedFg:   nil,
			expectedBg:   &color.Gray{Y: 50},
			expectedBold: false,
		},
		"[48;5;238m": {
			inputSeq:     esc("[48;5;238m"),
			expectedFg:   nil,
			expectedBg:   &color.Gray{Y: 60},
			expectedBold: false,
		},
		"[48;5;239m": {
			inputSeq:     esc("[48;5;239m"),
			expectedFg:   nil,
			expectedBg:   &color.Gray{Y: 70},
			expectedBold: false,
		},
		"[48;5;240m": {
			inputSeq:     esc("[48;5;240m"),
			expectedFg:   nil,
			expectedBg:   &color.Gray{Y: 80},
			expectedBold: false,
		},
		"[48;5;241m": {
			inputSeq:     esc("[48;5;241m"),
			expectedFg:   nil,
			expectedBg:   &color.Gray{Y: 90},
			expectedBold: false,
		},
		"[48;5;242m": {
			inputSeq:     esc("[48;5;242m"),
			expectedFg:   nil,
			expectedBg:   &color.Gray{Y: 100},
			expectedBold: false,
		},
		"[48;5;243m": {
			inputSeq:     esc("[48;5;243m"),
			expectedFg:   nil,
			expectedBg:   &color.Gray{Y: 110},
			expectedBold: false,
		},
		"[48;5;244m": {
			inputSeq:     esc("[48;5;244m"),
			expectedFg:   nil,
			expectedBg:   &color.Gray{Y: 120},
			expectedBold: false,
		},
		"[48;5;245m": {
			inputSeq:     esc("[48;5;245m"),
			expectedFg:   nil,
			expectedBg:   &color.Gray{Y: 130},
			expectedBold: false,
		},
		"[48;5;246m": {
			inputSeq:     esc("[48;5;246m"),
			expectedFg:   nil,
			expectedBg:   &color.Gray{Y: 140},
			expectedBold: false,
		},
		"[48;5;247m": {
			inputSeq:     esc("[48;5;247m"),
			expectedFg:   nil,
			expectedBg:   &color.Gray{Y: 150},
			expectedBold: false,
		},
		"[48;5;248m": {
			inputSeq:     esc("[48;5;248m"),
			expectedFg:   nil,
			expectedBg:   &color.Gray{Y: 160},
			expectedBold: false,
		},
		"[48;5;249m": {
			inputSeq:     esc("[48;5;249m"),
			expectedFg:   nil,
			expectedBg:   &color.Gray{Y: 170},
			expectedBold: false,
		},
		"[48;5;250m": {
			inputSeq:     esc("[48;5;250m"),
			expectedFg:   nil,
			expectedBg:   &color.Gray{Y: 180},
			expectedBold: false,
		},
		"[48;5;251m": {
			inputSeq:     esc("[48;5;251m"),
			expectedFg:   nil,
			expectedBg:   &color.Gray{Y: 190},
			expectedBold: false,
		},
		"[48;5;252m": {
			inputSeq:     esc("[48;5;252m"),
			expectedFg:   nil,
			expectedBg:   &color.Gray{Y: 200},
			expectedBold: false,
		},
		"[48;5;253m": {
			inputSeq:     esc("[48;5;253m"),
			expectedFg:   nil,
			expectedBg:   &color.Gray{Y: 210},
			expectedBold: false,
		},
		"[48;5;254m": {
			inputSeq:     esc("[48;5;254m"),
			expectedFg:   nil,
			expectedBg:   &color.Gray{Y: 220},
			expectedBold: false,
		},
		"[48;5;255m": {
			inputSeq:     esc("[48;5;255m"),
			expectedFg:   nil,
			expectedBg:   &color.Gray{Y: 230},
			expectedBold: false,
		},
		"[48;5;231m": {
		...
		"[48;5;52m": {
			...
			expectedFg:   nil,
			expectedBg:   &color.RGBA{R: 95, A: 255},
			expectedBold: false,
		},
		"[48;5;88m": {
			inputSeq:     esc("[48;5;88m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{R: 135, A: 255},
			expectedBold: false,
		},
		"[48;5;124m": {
			inputSeq:     esc("[48;5;124m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{R: 175, A: 255},
			expectedBold: false,
		},
		"[48;5;160m": {
			inputSeq:     esc("[48;5;160m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{R: 215, A: 255},
			expectedBold: false,
		},
		"[48;5;196m": {
			inputSeq:     esc("[48;5;196m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{R: 255, A: 255},
			expectedBold: false,
		},
		"[32;48;5;16m": {
		...
		"[48;5;22m": {
			...
			expectedFg:   nil,
			expectedBg:   &color.RGBA{G: 95, A: 255},
			expectedBold: false,
		},
		"[48;5;28m": {
			inputSeq:     esc("[48;5;28m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{G: 135, A: 255},
			expectedBold: false,
		},
		"[48;5;34m": {
			inputSeq:     esc("[48;5;34m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{G: 175, A: 255},
			expectedBold: false,
		},
		"[48;5;40m": {
			inputSeq:     esc("[48;5;40m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{G: 215, A: 255},
			expectedBold: false,
		},
		"[48;5;46m": {
			inputSeq:     esc("[48;5;46m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{G: 255, A: 255},
			expectedBold: false,
		},
		"[34;48;5;16m": {
		...
		"[48;5;17m": {
			...
			expectedFg:   nil,
			expectedBg:   &color.RGBA{B: 95, A: 255},
			expectedBold: false,
		},
		"[48;5;18m": {
			inputSeq:     esc("[48;5;18m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{B: 135, A: 255},
			expectedBold: false,
		},
		"[48;5;19m": {
			inputSeq:     esc("[48;5;19m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{B: 175, A: 255},
			expectedBold: false,
		},
		"[48;5;20m": {
			inputSeq:     esc("[48;5;20m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{B: 215, A: 255},
			expectedBold: false,
		},
		"[48;5;21m": {
			inputSeq:     esc("[48;5;21m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{B: 255, A: 255},
			expectedBold: false,
		},
		"[33;48;5;16m": {
		...
		"[48;5;58m": {
			...
			expectedFg:   nil,
			expectedBg:   &color.RGBA{R: 95, G: 95, A: 255},
			expectedBold: false,
		},
		"[48;5;100m": {
			inputSeq:     esc("[48;5;100m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{R: 135, G: 135, A: 255},
			expectedBold: false,
		},
		"[48;5;142m": {
			inputSeq:     esc("[48;5;142m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{R: 175, G: 175, A: 255},
			expectedBold: false,
		},
		"[48;5;184m": {
			inputSeq:     esc("[48;5;184m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{R: 215, G: 215, A: 255},
			expectedBold: false,
		},
		"[48;5;226m": {
			inputSeq:     esc("[48;5;226m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{R: 255, G: 255, A: 255},
			expectedBold: false,
		},
		"[35;48;5;16m": {
		...
		"[48;5;53m": {
			...
			expectedFg:   nil,
			expectedBg:   &color.RGBA{R: 95, B: 95, A: 255},
			expectedBold: false,
		},
		"[48;5;90m": {
			inputSeq:     esc("[48;5;90m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{R: 135, B: 135, A: 255},
			expectedBold: false,
		},
		"[48;5;127m": {
			inputSeq:     esc("[48;5;127m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{R: 175, B: 175, A: 255},
			expectedBold: false,
		},
		"[48;5;164m": {
			inputSeq:     esc("[48;5;164m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{R: 215, B: 215, A: 255},
			expectedBold: false,
		},
		"[48;5;201m": {
			inputSeq:     esc("[48;5;201m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{R: 255, B: 255, A: 255},
			expectedBold: false,
		},
		"[36;48;5;16m": {
		...
		"[48;5;23m": {
			...
			expectedFg:   nil,
			expectedBg:   &color.RGBA{G: 95, B: 95, A: 255},
			expectedBold: false,
		},
		"[48;5;30m": {
			inputSeq:     esc("[48;5;30m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{G: 135, B: 135, A: 255},
			expectedBold: false,
		},
		"[48;5;37m": {
			inputSeq:     esc("[48;5;37m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{G: 175, B: 175, A: 255},
			expectedBold: false,
		},
		"[48;5;44m": {
			inputSeq:     esc("[48;5;44m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{G: 215, B: 215, A: 255},
			expectedBold: false,
		},
		"[48;5;51m": {
			inputSeq:     esc("[48;5;51m"),
			expectedFg:   nil,
			expectedBg:   &color.RGBA{G: 255, B: 255, A: 255},
			expectedBold: false,
		},
	}
...
func TestHandleOutput_xterm_256_2(t *testing.T) {
	tests := map[string]struct {
		...
		"[38;5;15m": {
			...
			expectedFg:   &color.RGBA{R: 255, G: 255, B: 255, A: 255}, // White
			expectedBg:   nil,
			expectedBold: false,
		},
		"[38;5;16m": {
			inputSeq:     esc("[38;5;16m"),
			expectedFg:   &color.RGBA{A: 255},
			expectedBg:   nil,
			expectedBold: false,
		},
		"[38;5;17m": {
			inputSeq:     esc("[38;5;17m"),
			expectedFg:   &color.RGBA{B: 95, A: 255}, // Dark Blue
			expectedBg:   nil,
			expectedBold: false,
		},
		"[38;5;18m": {
			inputSeq:     esc("[38;5;18m"),
			expectedFg:   &color.RGBA{B: 135, A: 255}, // Dark Green
			expectedBg:   nil,
			expectedBold: false,
		},
		"[38;5;19m": {
			inputSeq:     esc("[38;5;19m"),
			expectedFg:   &color.RGBA{B: 175, A: 255}, // Dark Cyan
			expectedBg:   nil,
			expectedBold: false,
		},
		"[38;5;20m": {
			inputSeq:     esc("[38;5;20m"),
			expectedFg:   &color.RGBA{B: 215, A: 255}, // Dark Red
			expectedBg:   nil,
			expectedBold: false,
		},
		"[38;5;21m": {
			inputSeq:     esc("[38;5;21m"),
			expectedFg:   &color.RGBA{B: 255, A: 255}, // Dark Purple
			expectedBg:   nil,
			expectedBold: false,
		},
		"[38;5;22m": {
			inputSeq:     esc("[38;5;22m"),
			expectedFg:   &color.RGBA{G: 95, A: 255},
			expectedBg:   nil,
			expectedBold: false,
		},
		"[38;5;23m": {
			inputSeq:     esc("[38;5;23m"),
			expectedFg:   &color.RGBA{G: 95, B: 95, A: 255},
			expectedBg:   nil,
			expectedBold: false,
		},
		"[38;5;24m": {
			inputSeq:     esc("[38;5;24m"),
			expectedFg:   &color.RGBA{G: 95, B: 135, A: 255},
			expectedBg:   nil,
			expectedBold: false,
		},
		"[38;5;25m": {
			inputSeq:     esc("[38;5;25m"),
			expectedFg:   &color.RGBA{G: 95, B: 175, A: 255},
			expectedBg:   nil,
			expectedBold: false,
		},
		"[38;5;26m": {
			inputSeq:     esc("[38;5;26m"),
			expectedFg:   &color.RGBA{G: 95, B: 215, A: 255},
			expectedBg:   nil,
			expectedBold: false,
		},
		"[38;5;27m": {
			inputSeq:     esc("[38;5;27m"),
			expectedFg:   &color.RGBA{G: 95, B: 255, A: 255},
			expectedBg:   nil,
			expectedBold: false,
		},
		"[38;5;28m": {
			inputSeq:     esc("[38;5;28m"),
			expectedFg:   &color.RGBA{G: 135, A: 255},
			expectedBg:   nil,
			expectedBold: false,
		},
		"[38;5;29m": {
			inputSeq:     esc("[38;5;29m"),
			expectedFg:   &color.RGBA{G: 135, B: 95, A: 255},
			expectedBg:   nil,
			expectedBold: false,
		},
		"[38;5;30m": {
			inputSeq:     esc("[38;5;30m"),
			expectedFg:   &color.RGBA{G: 135, B: 135, A: 255}, // Cyan
			expectedBg:   nil,
			expectedBold: false,
		},
		"[38;5;31m": {
			inputSeq:     esc("[38;5;31m"),
			expectedFg:   &color.RGBA{G: 135, B: 175, A: 255}, // Dark Green
			expectedBg:   nil,
			expectedBold: false,
		},
	}
...
func TestHandleOutput_24_bit_colour(t *testing.T) {
	tests := map[string]struct {
		...
		"SlateGrey": {
			...
			expectedFg:   &color.RGBA{R: 112, G: 128, B: 144, A: 255},
			expectedBg:   nil,
			expectedBold: false,
		},
		"OliveDrab": {
			inputSeq:     esc("[38;2;107;142;35m"),
			expectedFg:   &color.RGBA{R: 107, G: 142, B: 35, A: 255},
			expectedBg:   nil,
			expectedBold: false,
		},
		"goldenrod": {
			inputSeq:     esc("[38;2;218;165;32m"),
			expectedFg:   &color.RGBA{R: 218, G: 165, B: 32, A: 255},
			expectedBg:   nil,
			expectedBold: false,
		},
		"SaddleBrown": {
			inputSeq:     esc("[38;2;139;69;19m"),
			expectedFg:   &color.RGBA{R: 139, G: 69, B: 19, A: 255},
			expectedBg:   nil,
			expectedBold: false,
		},
		"DarkViolet (bg)": {
			...
			expectedFg:   color.Black,
			expectedBg:   &color.RGBA{R: 148, B: 211, A: 255},
			expectedBold: false,
		},
	}
