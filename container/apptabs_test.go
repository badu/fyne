...
func TestAppTabs_Selected(t *testing.T) {
	tab1 := &TabItem{Text: "Test1", Content: widget.NewLabel(widget.LabelWithStaticText("Test1"))}
	tab2 := &TabItem{Text: "Test2", Content: widget.NewLabel(widget.LabelWithStaticText("Test2"))}
...
func TestAppTabs_SelectedIndex(t *testing.T) {
	tabs := NewAppTabs(&TabItem{Text: "Test", Content: widget.NewLabel(widget.LabelWithStaticText("Test"))})
...
func TestAppTabs_Select(t *testing.T) {
	...
	tabs.Select(NewTabItem("Test3", widget.NewLabel(widget.LabelWithStaticText("Test3"))))
	assert.Equal(t, tab2, tabs.Selected())
}

func TestAppTabs_SelectIndex(t *testing.T) {
	tabs := NewAppTabs(&TabItem{Text: "Test1", Content: widget.NewLabel(widget.LabelWithStaticText("Test1"))},
		&TabItem{Text: "Test2", Content: widget.NewLabel(widget.LabelWithStaticText("Test2"))})
...
func TestAppTabs_ShowAfterAdd(t *testing.T) {
	...
	tabs.Append(NewTabItem("test", widget.NewLabel(widget.LabelWithStaticText("Test"))))
