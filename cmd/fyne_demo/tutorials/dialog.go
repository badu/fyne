...
func dialogScreen(win fyne.Window) fyne.CanvasObject {
	openFile := widget.NewButton(
		widget.ButtonWithLabel("File Open With Filter (.jpg or .png)"),
	...
	saveFile := widget.NewButton(
		widget.ButtonWithLabel("File Save"),
		widget.ButtonWithCallback(
			func() {
	...
	openFolder := widget.NewButton(
		widget.ButtonWithLabel("Folder Open"),
		widget.ButtonWithCallback(
			func() {
	...
	return container.NewVScroll(
		container.NewVBox(
			...
			widget.NewButton(
				widget.ButtonWithLabel("Confirm"),
				widget.ButtonWithCallback(
					func() {
			...
			openFolder,
			widget.NewButton(
				widget.ButtonWithLabel("Color Picker"),
				widget.ButtonWithCallback(
					func() {
			...
			widget.NewButton(
				widget.ButtonWithLabel("Advanced Color Picker"),
				widget.ButtonWithCallback(
					func() {
						advancedPicker.Show()
					},
			...
			widget.NewButton(
				widget.ButtonWithLabel("Form Dialog (Login Form)"),
				widget.ButtonWithCallback(
					func() {
