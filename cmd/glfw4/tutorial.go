...
import (
	...
	"fyne.io/fyne/v2/cmd/glfw4/glfont"
	"fyne.io/fyne/v2/cmd/glfw4/glutils"
	"fyne.io/fyne/v2/cmd/glfw4/sections"
	"fyne.io/fyne/v2/cmd/glfw4/sections/getstarted"
	"fyne.io/fyne/v2/cmd/glfw4/sections/lighting"
...
func init() {
	...
	if err := os.Chdir(wd + "/cmd/glfw4"); err != nil {
