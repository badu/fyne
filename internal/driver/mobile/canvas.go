...
func (c *canvas) waitForDoubleTap(co fyne.CanvasObject, ev *fyne.PointEvent, tapCallback func(Tappable, *fyne.PointEvent), doubleTapCallback func(DoubleTappable, *fyne.PointEvent)) {
