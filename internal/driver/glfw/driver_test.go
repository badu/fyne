...
func Test_gLDriver_AbsolutePositionForObject(t *testing.T) {
	...
	cr1c1 := widget.NewLabel(widget.LabelWithStaticText("row 1 col 1"))
	cr1c2 := widget.NewLabel(widget.LabelWithStaticText("row 1 col 2"))
	cr1c3 := widget.NewLabel(widget.LabelWithStaticText("row 1 col 3"))
	cr2c1 := widget.NewLabel(widget.LabelWithStaticText("row 2 col 1"))
	cr2c2 := widget.NewLabel(widget.LabelWithStaticText("row 2 col 2"))
	cr2c3 := widget.NewLabel(widget.LabelWithStaticText("row 2 col 3"))
	cr3c1 := widget.NewLabel(widget.LabelWithStaticText("row 3 col 1"))
	cr3c2 := widget.NewLabel(widget.LabelWithStaticText("row 3 col 2"))
	cr3c3 := widget.NewLabel(widget.LabelWithStaticText("row 3 col 3"))
	...
	ovli1 := widget.NewLabel(widget.LabelWithStaticText("Overlay Item 1"))
	ovli2 := widget.NewLabel(widget.LabelWithStaticText("Overlay Item 2"))
	ovli3 := widget.NewLabel(widget.LabelWithStaticText("Overlay Item 3"))
