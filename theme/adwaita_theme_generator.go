...
{{ if contains $icon.StaticName "symbolic" }}
    {{$name}}: NewThemedResource(&fyne.StaticResource{
        StaticName: "{{$icon.StaticName}}",
        StaticContent: []byte({{ printf "%q" $icon.Content}}),
    }),
{{else}}
    {{$name}}: &fyne.StaticResource{
        StaticName: "{{$icon.StaticName}}",
        StaticContent: []byte({{ printf "%q" $icon.Content}}),
    },
{{end}}
...
var (
	...
	colorToGet = map[string]string{
		"ColorNameBackground":        "window_bg_color",  // or "view_bg_color"
		"ColorNameForeground":        "window_fg_color",  // or "view_fg_color"
		"ColorNameMenuBackground":    "popover_bg_color", // not sure about this one
		"ColorNameSelection":         "headerbar_bg_color",
		"ColorNameOverlayBackground": "view_bg_color",      // not sure about this one
		"ColorNamePrimary":           "accent_bg_color",    // accent_color is the primary color for Adwaita
		"ColorNameInputBackground":   "view_bg_color",      // or "window_bg_color"
		"ColorNameButton":            "headerbar_bg_color", // it's the closer color to the button color
		"ColorNameShadow":            "shade_color",
		"ColorNameSuccess":           "success_bg_color",
		"ColorNameWarning":           "warning_bg_color", // Adwaita doesn't have "orange_x" color for "dark"
		"ColorNameError":             "error_bg_color",
	}
	...
	standardColorToGet = map[string]string{
		"ColorRed":    "red_3,red_4",     // based on error_bg_color
		"ColorOrange": "orange_3",        // more or less the same as warning_bg_color
		"ColorYellow": "yellow_3",        // more or less the same as warning_bg_color
		"ColorGreen":  "green_4,green_5", // based on success_bg_color
		"ColorBlue":   "blue_3",
		"ColorPurple": "purple_3",
		"ColorBrown":  "brown_3",
		"ColorGray":   "dark_2",
		// specific
		"ColorNameScrollBar": "dark_5,light_1", // and we will change the alpha value later
	}
