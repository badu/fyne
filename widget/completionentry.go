...
type CompletionEntry struct {
	...
	CustomUpdate func(id ListItemID, object fyne.CanvasObject)
}
...
func (c *CompletionEntry) ShowCompletion() {
	...
	if c.popupMenu == nil {
		c.popupMenu = NewPopUp(c.navigableList, holder)
	}
	c.popupMenu.Resize(c.maxSize())
...
func newNavigableList(items []string, entry *Entry, setTextFromMenu func(string), hide func(),
	create func() fyne.CanvasObject, update func(id ListItemID, object fyne.CanvasObject)) *navigableList {
	n := &navigableList{
		entry:           entry,
		selected:        -1,
	...
	n.List = List{
		...
		UpdateItem: func(i ListItemID, o fyne.CanvasObject) {
			if fn := n.customUpdate; fn != nil {
				fn(i, o)
				return
			}
			o.(*Label).SetText(n.items[i])
		},
