...
func GetTextRange(t *TermGrid, blockMode bool, startRow, startCol, endRow, endCol int) string {
	...
	forRange(t, blockMode, startRow, startCol, endRow, endCol, func(cell *TextGridCell) {
...
// - eachCell (func(cell *TextGridCell)): A function that takes a pointer to a TextGridCell and is applied to each cell in the specified range. Pass `nil` if you don't want to apply a cell function.
// - eachRow (func(row *TextGridRow)): A function that takes a pointer to a TextGridRow and is applied to each row in the specified range. Pass `nil` if you don't want to apply a row function.
//
// Note:
...
func forRange(t *TermGrid, blockMode bool, startRow, startCol, endRow, endCol int, eachCell func(cell *TextGridCell), eachRow func(row *TextGridRow)) {
